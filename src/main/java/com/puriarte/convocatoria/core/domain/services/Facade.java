...
//	}
	 ...
	 * @throws Exception 
	 */
	public PersonMovil insertPersonMovil(String number, String document, DocumentType documentType) throws Exception {
		return movilService.getInstance().insert(number, document, documentType);
	}

	public PersonMovil insertPersonMovil(Person person, String movilNumber) throws Exception {
