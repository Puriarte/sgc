...
public class MovilService {
	...
	public Movil selectMovil(String nroDestino, int idStatus) throws Exception {
		final EntityManager em = getEntityManager();
	...
	private PersonMovil insertPersonAndMovil( String number, String document, DocumentType documentType) throws Exception{
	...
	private Company getMovilCompanyFromNumber(String number) throws Exception {
		final EntityManager em = getEntityManager();
	 ...
	 * @throws Exception 
	 */
	public PersonMovil insert(String number, String document, DocumentType documentType) throws Exception {
		Person person =null;
		try {
			// Busco la persona
...
//			}
	...
	public PersonMovil insert(Person person, String movilNumber) throws Exception {
		try {
