...
<head>
	...
	<link href="css/jquery/jquery.jdMenu.css" rel="stylesheet" type="text/css" />
...
<div style="position: absolute;left:0px; bottom:0px;width: 100%">
  <table width="100%" border="0" align="center" cellpadding="2" cellspacing="0">
    <tr>
      <td>
      <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="ui-widget-header">
        <tr>
