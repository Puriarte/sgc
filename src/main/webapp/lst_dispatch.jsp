...
<head>
	...
	<script src="js/dispatchGrid.js?var=<%= com.jcabi.manifests.Manifests.read("App-Version") %>" type="text/javascript"></script>
...
<body>
	...
	<div align="center" class="ui-widget">
		...
		<html:form action="/lstDispatch.do" method="post" styleId="frmLstDispatch" style="margin: 0px 0px 0px 0px;">
			<bean:define id="stFechaInicio" name="frmLstDispatch" property="fechaDesde" />
			<bean:define id="stFechaFin" name="frmLstDispatch" property="fechaHasta" />
			...
			<div id="dialogo_ingresar_dispatch" title="Modificar Convocatoria" style="display: none;">
				<table width="100%" cellpadding="0" border="0" cellspacing="2">
				<tr>
					<td width="30%" style="padding-left: 10px; font-weight: bold;" align="left" valign="top" bgcolor="#E2F1F1">Destinatarios del mensaje</td>
					<td width="70%" style="padding-left: 10px; font-weight: bold;" align="left" valign="top" bgcolor="#FFFFFF">
						<input type="hidden" name="nroDestino" size="40" value="" id="nroDestino"> 
						<textarea id="nroDestinoDesc" name="nroDestinoDesc" rows="3" cols="60"></textarea>
					</td>
				</tr>
				<tr>
					<td width="30%" style="padding-left: 10px; font-weight: bold;"	align="left" valign="top" bgcolor="#E2F1F1">Nombre</td>
					<td width="70%" style="padding-left: 10px; font-weight: bold;"	align="left" valign="top" bgcolor="#FFFFFF">
						<input name="name" id="name" width="190" />
					</td>
				</tr>
				<tr>
			...
			<div align="center" title="Filtros de la consulta">
				<fieldset>
						...
						<div class="row">
							...
							<div class="col-md-2">
								<select class="form-control" name="dispatchStatus" id="dispatchStatus" >
									...
									<logic:iterate name="frmLstDispatch" property="colDispatchStatus"	id="item" indexId="idx">
										<logic:equal name="frmLstDispatch" property="dispatchStatus" value="${item.id}">
											<option selected="selected" value="${item.id}">${item.name}</option>
										</logic:equal> 
										<logic:notEqual name="frmLstDispatch" property="dispatchStatus"  value="${item.id}">
					...
					<td width="100%">
						<table border="0" width="100%" cellpadding="0" cellspacing="0">
							<tr height="30" valign="middle">
								<td align="center">
									<input type="button" name="bcAlta" value="Modificar" id="btnIngresar" class="ui-button ui-widget ui-state-default ui-corner-all" role="button">
								</td>
							</tr>
						</table>
					</td>
